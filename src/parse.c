...
int read_whole(char* buffer, const char* filename)
{

}

// these should return something, or into a global con

void parse_super(const char* content)
{

}

void parse_scene(const char* content)
{

}

void parse_pack(const char* content)
{
